...
from app.modules.heroes.services.schemas import HeroSearchResult
...
class HeroServices:
    ...
    async def search(
        ...
        count, items = await self.heroes.select_with_count(
            *filters,
        ...
        return HeroSearchResult(count=count, items=items)
